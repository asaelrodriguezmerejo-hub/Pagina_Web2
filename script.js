...
const button = document.getElementsByClassName('portafolio')[0];
button.addEventListener('click', () => {
  window.location.href = 'Portafolio Da/indexD.html';
});

const button2 = document.getElementsByClassName('portafolio')[1];
button2.addEventListener('click', () => {
  window.location.href = 'Practica/Forma.html';
});

const button3 = document.getElementsByClassName('portafolio')[2];
button3.addEventListener('click', () => {
  window.location.href = 'Portafolio-Digital-main/indexE.html';
});

const button4 = document.getElementsByClassName('btn-proyectos')[0];
button4.addEventListener('click', () => {
  window.location.href = 'Portafolio Da/Numero_magico/NumeroMagico.html';
});